...
public class GameActivity extends AppCompatActivity {
    ...
    protected void setContainerResId(int containerResId) {
    ...
    public void navigateToFragment(GameFragment gameFragment, int enter, int exit) {
        getSupportFragmentManager()
                .beginTransaction()
                .setCustomAnimations(enter, exit, enter, exit)
                .replace(mContainerResId, gameFragment, TAG_FRAGMENT)
                .addToBackStack(null)
                .commit();
    }
