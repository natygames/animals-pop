...
public class MySoundManager extends SoundManager {
    ...
    public MySoundManager(Context context) {
        ...
        loadSound(MySoundEvent.SWEEP_01, R.raw.sweep_01);
        loadSound(MySoundEvent.SWEEP_02, R.raw.sweep_02);
        loadSound(MySoundEvent.BOMB_BUBBLE_EXPLODE, R.raw.bomb_explode);
