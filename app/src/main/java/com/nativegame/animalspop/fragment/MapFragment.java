...
import com.nativegame.animalspop.dialog.AdLivesDialog;
import com.nativegame.animalspop.dialog.LevelDialog;
import com.nativegame.animalspop.dialog.SettingDialog;
import com.nativegame.animalspop.dialog.ShopDialog;
import com.nativegame.animalspop.dialog.WheelDialog;
...
public class MapFragment extends GameFragment implements View.OnClickListener,
    ...
    private void init() {
        ...
        Utils.createButtonEffect(btnShop);
        Utils.createButtonEffect(btnCoin);
        Utils.createButtonEffect(btnWheel);
        // Init lives text
        TextView txtLives = (TextView) getView().findViewById(R.id.txt_lives);
        txtLives.setOnClickListener(this);
        Utils.createButtonEffect(txtLives);
        // Init layout
        initLevelButton();
        initLevelStar();
        initAd();
    ...
    private void initLevelButton() {
        ...
        for (int i = 1; i <= TOTAL_LEVEL; i++) {
            ...
            if (i <= mCurrentLevel) {
                ...
                Utils.createButtonEffect(txtLevel);
            } else {
    ...
    private void loadCoin() {
        ...
        int coin = mDatabaseHelper.getItemNum(DatabaseHelper.ITEM_COIN);
